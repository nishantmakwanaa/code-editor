...
export const BASE_SERVER_URL =
  ...
  (IS_DEV_ENV ? 'http://localhost:3001' : 'https://alpha-server.example.com');

export const STATUS_URL = 'https://alpha-status.example.com';
...
export const SITE_NAME = 'Alpha - Code Collaboration Platform';
export const SITE_DESCRIPTION =
  'Your collaborative coding space, reimagined. Code together now on Alpha, no sign-up required.';
...
export const LATENCY_TEST_DESCRIPTION =
  'Test your latency to the Alpha server.';
...
export const PORTFOLIO_URL = 'https://nishantmakwanaa.vercel.app';
export const CONTACT_URL = 'https://nishantmakwanaa.vercel.app';
export const REPO_URL = 'https://github.com/nishantmakwaana/alpha';
export const GITHUB_URL = 'https://github.com/nishantmakwaana';
export const LINKEDIN_URL = 'https://linkedin.com/in/nishantmakwanaa';
